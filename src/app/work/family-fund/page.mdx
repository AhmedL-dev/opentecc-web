import logo from '@/images/icons/ecommerce-black.svg'
...
export const caseStudy = {
  ...
  title: 'E-Commerce',
  description:
    'In the dynamic realm of e-commerce, we\'ve redefined user experiences. Our commitment to innovation resulted in the creation of intuitive, user-friendly platforms. From streamlined checkout processes to convenient payment options, we consistently elevate the online shopping experience.',
  summary: [
