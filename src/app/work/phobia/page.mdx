import logo from '@/images/icons/fintech-black.svg'
...
export const caseStudy = {
  ...
  title: 'Fintech',
  description:
    'Navigating the fintech landscape, OpenTecc is at the forefront of online financial evolution. Our web development endeavors demonstrate a commitment to reshaping financial transactions online. Through seamless web development, we contribute to shaping the future of fintech.',
  summary: [
