import logo from '@/images/icons/realestate-black.svg'
...
export const caseStudy = {
  ...
  title: 'Real Estate',
  description:
    'At Opentecc, we\'re not setting out to be just another digital real estate solution. We\'re your companions in the quest for the perfect home, weaving a digital tapestry of experiences that redefine excellence. Because for us, it\'s not just about algorithms; it\'s about making your journey home feel like a warm embrace.',
  summary: [
